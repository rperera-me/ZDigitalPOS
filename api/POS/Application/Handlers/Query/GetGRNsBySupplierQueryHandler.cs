...
{
    public class GetGRNsBySupplierQueryHandler : IRequestHandler<GetGRNsBySupplierQuery, IEnumerable<GRNDto>>
    {
        ...
        public GetGRNsBySupplierQueryHandler(
        ...
        public async Task<IEnumerable<GRNDto>> Handle(GetGRNsBySupplierQuery request, CancellationToken cancellationToken)
        {
            var grns = await _grnRepository.GetBySupplierIdAsync(request.SupplierId);
